...
#define TTL 64
#define IP_ETH 0x0800
#define IP_START sizeof(struct ether_header)
#define ICMP_START (IP_START + sizeof(struct iphdr))
...
#define ICMP_DATA_START (ICMP_START + sizeof(struct icmphdr))
